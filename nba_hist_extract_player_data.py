...
years = games_2022['season_year'].unique().tolist()
years


games_2022.reset_index(drop=True, inplace=True)
last = games_2022[games_2022['player_id']==1628962]
last = last[last['season_year']== 2022]
last

games_2022.iloc[48, 0]
